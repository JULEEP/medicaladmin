...
export default function ActivePharmacyList() {
  ...
  const fetchActivePharmacies = async () => {
    ...
    setError("");
    try {
      const res = await fetch("http://31.97.206.144:7021/api/admin/getallactiveorders");
      const data = await res.json();
      if (!res.ok) throw new Error(data.message || "Failed to fetch active pharmacies");
  ...
  const downloadCSV = () => {
    ...
    link.setAttribute("download", `active_pharmacies_${new Date().toISOString().split('T')[0]}.csv`);
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 py-6">
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
          ...
          <div className="px-5 py-4 border-b border-gray-200 bg-gradient-to-r from-green-600 to-emerald-600 text-white">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
              <div>
                <h1 className="text-2xl font-bold">Active Pharmacy Management</h1>
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                ...
                <div className="relative flex-1 sm:max-w-xs">
                  ...
                  <input
                    type="text"
                    placeholder="Search active pharmacies..."
                    value={searchTerm}
                    onChange={(e) => setSearchTerm(e.target.value)}
                    className="block w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-gray-900 text-sm"
                  />
                </div>
                        ...
                        <tr key={pharmacy._id} className="hover:bg-green-50 transition-colors duration-150">
                          ...
                          <td className="px-3 py-3">
                            <div className="flex items-center">
                              ...
                              <div className="ml-3 min-w-0 flex-1">
                                ...
                                <div className="text-xs text-gray-500 truncate" title={`Pass: ${pharmacy.password}`}>
                                  Pass: {truncateText(pharmacy.password, 10)}
                                </div>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="px-3 py-3">
                            <div className="min-w-0 flex-1">
                              ...
                              <div className="text-xs text-gray-500 truncate" title={pharmacy.vendorPhone}>
                                {pharmacy.vendorPhone}
                              </div>
                            </div>
                          </td>
            ...
            <form onSubmit={handleEditSubmit} className="space-y-4">
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="block w-full border border-gray-300 rounded-lg shadow-sm py-2 px-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent text-sm"
                  />
                </div>
                <div>
              ...
              <div className="flex justify-end space-x-3 pt-4">
                <button
                  ...
                  className="inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-colors duration-200"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 transition-colors duration-200"
                >
                    ...
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <button
                          ...
                          className="inline-flex items-center px-2 py-1 text-xs font-medium text-white bg-green-600 hover:bg-green-700 rounded-lg shadow-sm transition-colors duration-200"
                        >
                          Update
                        </button>
                      </div>
